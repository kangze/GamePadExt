...
--register font
LSM:Register("font","font1",[[Interface\Addons\GamePadExt\media\fonts\1.ttf]]);


LSM:Register("statusbar", "MaoRSkada",          [[Interface\Addons\GamePadExt\media\statusbar\MaoRSkada]])
LSM:Register("statusbar", "AtlzSkada",          [[Interface\Addons\GamePadExt\media\statusbar\AtlzSkada]])
LSM:Register("statusbar", "YaSkada",            [[Interface\Addons\GamePadExt\media\statusbar\Yaskada]])
LSM:Register("statusbar", "YaSkada02",          [[Interface\Addons\GamePadExt\media\statusbar\Yaskada02]])
LSM:Register("statusbar", "YaSkada03",          [[Interface\Addons\GamePadExt\media\statusbar\Yaskada03]])
LSM:Register("statusbar", "YaSkada04",          [[Interface\Addons\GamePadExt\media\statusbar\Yaskada04]])
LSM:Register("statusbar", "YaSkada05",          [[Interface\Addons\GamePadExt\media\statusbar\Yaskada05]])
LSM:Register("statusbar", "elvskada",           [[Interface\Addons\GamePadExt\media\statusbar\elvskada]])
LSM:Register("statusbar", "elvskada2",          [[Interface\Addons\GamePadExt\media\statusbar\elvskada2]])
LSM:Register("statusbar", "01",                 [[Interface\Addons\GamePadExt\media\statusbar\c0101]])
LSM:Register("statusbar", "02",                 [[Interface\Addons\GamePadExt\media\statusbar\c006]])


local function mAddStatusbar(name, file)
    LSM:Register("statusbar", name, "Interface\\AddOns\\YaMedia\\textures\\" .. file)
end
